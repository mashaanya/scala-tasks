...
object Main extends App {
  ...
  def Morze(a: List[Char], l: List[String]): List[String] = a match {
    case i :: Nil => l :+ Codes(i)
    case i :: tail if (i == ' ') => Morze(tail, l :+ Codes(i))
    case i :: b :: tail if (b == ' ') => Morze(tail, l :+ Codes(i) + "/")
    case i :: tail if (i != " ") => Morze(tail, l :+ Codes(i) + "|")
  ...
  val a = "i am a scala programmer".toList
  val b = Morze(a, List())
}
```
task 6
